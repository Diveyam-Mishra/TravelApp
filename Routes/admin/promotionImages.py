...
async def uploadCarouselImages(files: List[UploadFile]=File(...), current_user:User=Depends(get_current_user), carousel_blob_client=Depends(get_blob_service_client), db:Session=Depends(get_db)):
